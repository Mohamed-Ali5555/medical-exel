    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-1 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\translate('city_update_form')}}
            </h2>
        </div>
        <!-- End Page Title -->
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label for="name" class="title-color text-capitalize">{{ \App\CPU\translate('name')}}</label>
                                    ...
                                    <select
                                      ...
                                      >
                                        ...
                                        @foreach($goverments as $goverment)
                                            <option
                                                value="{{$goverment['id']}}" {{ $goverment->id==$city->goverment_id ? 'selected' : ''}} >{{$goverment['name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
