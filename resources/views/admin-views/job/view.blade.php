    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-1 text-capitalize d-flex align-items-center gap-2">
                <img width="20" src="{{ asset('/public/assets/back-end/img/job.png') }}" alt="">
                {{ \App\CPU\translate('job') }}
            </h2>
        </div>
        <!-- End Page Title -->

        <!-- Content Row -->
        <div class="row pb-4 d--none" id="main-job"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label for="name"
                                            class="title-color text-capitalize">{{ \App\CPU\translate('job_name') }}</label>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-4 col-lg-6 mb-2 mb-md-0">
                                <h5 class="mb-0 text-capitalize d-flex gap-2">
                                    ...
                                    <span class="badge badge-soft-dark radius-50 fz-12">{{ $jobs->total() }}</span>
                                </h5>
                            </div>
                            <div class="col-md-8 col-lg-6">
                                <div
                                    ...
                                    <div id="job-btn">
                                        <button id="main-job-add" class="btn btn--primary text-nowrap">
                                            <i class="tio-add"></i>
                                            {{ \App\CPU\translate('job') }}
                                        </button>
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="columnSearchDatatable"
                            ...
                            @foreach ($jobs as $key => $job)
                                <tbody>
                                    <tr id="data-{{ $job->id }}">
                                        <td class="pl-xl-5">{{ $jobs->firstItem() + $key }}</td>
                                        <td>{{ \App\CPU\translate(str_replace('_', ' ', $job->name)) }}</td>



                                        {{-- <td>{{ $job->branch->gover_name }}</td> --}}
                                        ...
                                        <td class="text-center">
                                            <label class="mx-auto switcher">
                                                <input type="checkbox" class="status switcher_input"
                                                    id="{{ $job['id'] }}" {{ $job->status == 1 ? 'checked' : '' }}>
                                        ...
                                        <td>
                                            <div class="d-flex gap-10 justify-content-center">
                                                ...
                                                <a class="btn btn-outline-danger btn-sm cursor-pointer delete"
                                                    title="{{ \App\CPU\translate('Delete') }}" id="{{ $job['id'] }}">
...
@push('script')
    ...
    <script>
        ...
        $('.cancel').on('click', function() {
            $('.banner_form').attr('action', "{{ route('admin.job.store') }}");
            $('#main-job').hide();
        });
