                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="product_type" value="physical" required>
                                         
                                 
                                        <input type="hidden" name="digital_product_type" value="ready_after_sell"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="170655"  id="generate_number" name="code"
                                               class="form-control"
                            ...
                            <div class="row align-items-end">
                                ...
                                <input  type="hidden" value="1" min="0"
                                        step="0.01"
                                ...
                                <input  type="hidden" min="0" value="9999999" step="1" 
                                        name="current_stock"
                                        required>  
                                <input  type="hidden"
                                ...
                                <div>
                                    <label class="switcher">
                                        <input type="hidden" class="switcher_input" name="multiplyQTY">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="hidden" name="meta_title" placeholder="" class="form-control">
                                        </div>

                                        <div class="col-md-8 form-group">
                                            <label class="title-color">{{ \App\CPU\translate('Meta Description') }}</label>
                                            <input type="hidden" name="meta_description" class="form-control">
                                        </div>
