            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <input type="text" placeholder="Search..." id="datamohamed">
                        ...
                        <table id="datatable12"
                            ...
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th class="text-center">{{ \App\CPU\translate('best_offers') }}</th>
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            datatable1 = $('#datatable12').DataTable();

            //$('#datamohamed').keyup(function() {
            $('#datamohamed').keyup(function(){
