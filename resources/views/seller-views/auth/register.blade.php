            ...
            <div class="card __card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control form-control-user" id="exampleAddress" name="address"
                                value="{{ old('address') }}" placeholder="{{ \App\CPU\translate('address') }}" required>
                        </div>
                        <div class="col-sm-12">
                            {{-- <center>
            ...
            <div class="card __card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label"
                                        ...
                                        {{ \App\CPU\translate('register_banner') }}</label>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 ">
                            <select id="goverment_id" name="goverment_id" class="form-control SlectBox"
                                onclick="console.log($(this).val())" onchange="console.log('change is firing')">
                                <!--placeholder-->
                                <option value="" selected disabled> {{ \App\CPU\translate('choose_goverment') }}
                                </option>
                        ...
                        <div class="col-md-12">
                            <span class="text-danger">choose inside city or out side</span>
                        </div>
                        <div class="col-sm-6 ">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="option" value="In_side" checked
                                    style="clip:auto;    position: unset;
">
                                <label class="form-check-label" for="option1">
                                    {{ \App\CPU\translate('In_side') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-6 ">

                            <div class="form-check bg-red">
                                <input class="form-check-input" type="radio" name="option" value="Out_side"
                                    style="clip:auto;    position: unset;
">
                                <label class="form-check-label" for="option2">
                                    {{ \App\CPU\translate('Out_side') }}
                                </label>
                            </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            $('select[id="goverment_id"]').on('change', function() {
                // alert('mohamed'); //this is commit

                var branchId = $(this).val();
                {{-- alert(branchId); --}}
                var path = "{{ URL::to('goverment') }}/" + branchId;
                if (branchId) {
                    $.ajax({
                        url: path,
                        type: "GET",
