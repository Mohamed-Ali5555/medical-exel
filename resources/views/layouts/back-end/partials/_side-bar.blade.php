                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('promotion_management'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/goverment*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.goverment.list') }}"
                                    title="{{ \App\CPU\translate('goverments') }}">
                                    <i class="tio-photo-square-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('goverments') }}</span>
                                </a>
                            </li>
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/city*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.city.list') }}"
                                    title="{{ \App\CPU\translate('cities') }}">
                                    <i class="tio-photo-square-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('cities') }}</span>
                                </a>
                            </li>
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/job*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.job.list') }}"
                                    title="{{ \App\CPU\translate('jobs') }}">
                                    <i class="tio-photo-square-outlined nav-icon"></i>
                                    <span
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('user_section'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/sellers/withdraw-method/list') || Request::is('admin/sellers/withdraw-method/*') ? 'active' : '' }}">
                                        <a class="nav-link "
