...
var id = $(this).data('id');
              ...
              var input = $("input[name='" + fieldName + "'][id='" + id + "']");

                var currentVal = parseInt(input.val());
                
             //////////////////////////
             // var productId = input.attr('data-product-id'); // Get the product ID

              
           //  var productId = input.attr('data-id'); // Get the product ID
...
//alert (id);
            ...
            //////////////////////////
                if (!isNaN(currentVal)) {
                    ...
                    if (type == 'minus') {
//alert(id);  
  //if (id === 779227) { // Replace 'yourDesiredId' with the specific id you want to match
...
var id =  $('.btn-number').data('id');
              var input = $("input[id='" + id + "']");



         if ($('#add-to-cart-form input[name="quantity"]').val() > 0 && $('#add-to-cart-form input').val() == input && checkAddToCartValidity()) {
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
                    }
